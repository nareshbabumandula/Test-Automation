...
public class DifferentLocators {
	...
	public void f() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input[name='email']")).sendKeys("testuser@gmail.com");
		driver.findElement(By.cssSelector("input[id='q1']")).sendKeys("Test text");
		driver.findElement(By.cssSelector("[name='q2']")).sendKeys("Test Description");
